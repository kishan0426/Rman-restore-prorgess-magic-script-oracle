...
#Pulling alertlog from database
_alrtlog(){
$ORACLE_HOME/bin/sqlplus -S "/ as sysdba" << EOF > $ALRTLOG
select VALUE from v\$diag_info where NAME='Diag Trace';
EOF
}
#Use this function to monitor restore progress 
_restore_pct(){
while sleep 0.5;do
cat /dev/null > $RSTORE
...
echo "======================================================================"
#Check if restore completed from the alertlog file
